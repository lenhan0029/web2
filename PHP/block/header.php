        ...
        <div class="col-md-6 col-sm-6 col-6 col-lg-2">
            <div class="logo">
                <a href="?page=homepage">
                    <img src="images/logo/logo0.png" alt="logo images">
                </a>
            </div>
        </div>
        <div class="col-lg-8 d-none d-lg-block">
            <nav class="mainmenu__nav">
                <ul class="meninmenu d-flex justify-content-start" style="font-family:sans-serif">
                    ...
                    <li class="drop"><a href="?page=brand&brand=1&numpage=0">Giày</a>
                        <div class="megamenu mega03" style="width:auto">
                            <ul class="item item03">
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ?>
                                    <li><a href="?page=brand&brand=<?php echo $row['idbr'] ?>&numpage=0"><?php echo $row['namebr'] ?> </a></li>
                                <?php
                            } ?>
                            </ul>
                        </div>
                                ...
                                <div class="miniproduct" style="height:300px">
                                    ...
                                    if (isset($_SESSION['cart']))
                                        ...
                                        <div class="item01 d-flex mt--20">
                                            <div class="thumb">
                                                <a href="?page=product&id=<?php echo $product['idpr'] ?>"><img src="public/img/product/<?php echo $product['image'] ?>" alt="product images"></a>
                                            </div>
                                            <div class="content">
                                                <h6><a href="?page=product&id=<?php echo $product['idpr'] ?>"><?php echo $product['namepr'] ?></a></h6>
                                                ...
                                                <div class="product_prize d-flex justify-content-between">
                                                    ...
                                                    <ul class="d-flex justify-content-end">
                                                        ...
                                                        <li><a onclick="delete_cart(<?php echo $product['idpr'] ?>)"><i class="zmdi zmdi-delete"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="col-lg-12 d-none">
            <nav class="mobilemenu__nav">
                <ul class="meninmenu">
                    ...
                    <li><a href="?page=brand&brand=1&numpage=0">Giày</a>
                        <ul>
                            <?php
                            $result = getBrand();
                            while ($row = $result->fetch_assoc()) {
