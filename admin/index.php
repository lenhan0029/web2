...
<head>
    ...
    <link rel="stylesheet" href="../PHP/css/snackbar.css" />
...
<body class="animsition">
        ...
        <div class="page-container">
            ...
            switch ($page) {
                ...
                case "customer":
                    ...
                    require "block/modalAddUser.php";
                    break;
                case "order":
                    require "block/modalMoreOrder.php";
                    break;
                case "statiscal":
                    require "block/modalStatiscal.php";
                    break;
                default:
                    require "block/modalAddProduct.php";
                    require "block/modalupdateProduct.php";
    ...
    window.onload = function checkadmin() {
        $.ajax({
            url: "action/checkadmin.php",
        }).done(function(data){
            if(data==1){
                alert("bạn phải đăng nhập bằng tài khoản admin để sử dụng chức năng này");
                window.location.assign("http://localhost:8080/ProjectPHP/PHP/?page=homepage");
            }
        })
    }
    </script>
    ...
    <script src="js/checksignout.js"></script>
    <script src="js/statiscal.js"></script>
    <!-- Main JS-->
